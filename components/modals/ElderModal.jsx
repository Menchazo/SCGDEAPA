    ...
    <form onSubmit={handleSubmit}>
      <div className="form-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div><label className="block text-sm font-medium text-gray-700 mb-2">Fecha de Nacimiento *</label><input type="date" className="input-field" value={formData.birth_date} onChange={(e) => setFormData({ ...formData, birth_date: e.target.value })} required /></div>
          <div><label className="block text-sm font-medium text-gray-700 mb-2">Edad (calculada)</label><input type="number" className="input-field" value={formData.age} readOnly disabled /></div>
